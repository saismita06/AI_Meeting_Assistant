...
def get_system_info():
    ...
    try:
        ...
        transcription_endpoint = os.environ.get('TRANSCRIPTION_BASE_URL', 'http://whisper-asr:9000/v1')
        if asr_enabled:
            active_endpoint = ASR_BASE_URL or transcription_endpoint
        else:
            active_endpoint = transcription_endpoint
        ...
        return jsonify({
            ...
            'whisper_endpoint': transcription_endpoint,
            'asr_endpoint': active_endpoint if asr_enabled else None,
