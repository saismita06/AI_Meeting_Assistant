...
class Recording(db.Model):
    ...
    def to_dict(self, include_html=True, viewer_user=None, duplicate_info_map=None):
        ...
        if self.summary:
            from src.services.summary_export import render_summary_markdown
            display_summary = render_summary_markdown(self.summary, self.title)
        ...
        if include_html:
            ...
            data['summary_html'] = md_to_html(display_summary) if display_summary else ""
        else:
            data['notes_html'] = ""
            data['summary_html'] = ""
