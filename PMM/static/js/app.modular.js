...
import { parseSummaryContent } from './modules/utils/summary.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const app = createApp({
        setup() {
            ...
            const showSummaryDownloadMenu = ref(false);
            ...
            const structuredSummary = computed(() => {
                if (!selectedRecording.value || !selectedRecording.value.summary) {
                    return parseSummaryContent('');
                }
                return parseSummaryContent(selectedRecording.value.summary);
            });
